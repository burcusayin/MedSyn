...
# Taken from https://github.com/microsoft/clinical-self-verification/blob/main/data/icd/MIMIC%20IV%20cohort%20build.py
...
parser.add_argument('--mimic4_root')
parser.add_argument('--mimic4_note_root')
parser.add_argument('--output_file_with_icd9') 
parser.add_argument('--output_file_with_icd10')

args = parser.parse_args()
mimic4_root = args.mimic4_root 
mimic4_note_root = args.mimic4_note_root
output_file_icd9 = args.output_file_with_icd9 
output_file_icd10 = args.output_file_with_icd10 
...
if __name__ == "__main__":
    ...
    # Diagnosis & procedure
    mimic_diag = pd.read_csv(os.path.join(mimic4_root, 'hosp', 'diagnoses_icd.csv.gz'), 
    ...
    # Discharge summary
    mimic_notes = pd.read_csv(os.path.join(mimic4_note_root, 'discharge.csv'),
    ...
    os.makedirs(os.path.dirname(output_file_icd9), exist_ok = True)
    mimiciv_9.to_pickle(output_file_icd9)
    os.makedirs(os.path.dirname(output_file_icd10), exist_ok = True)
    mimiciv_10.to_pickle(output_file_icd10)