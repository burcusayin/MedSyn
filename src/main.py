...
if __name__ == "__main__":
    ...
    discharge_data = discharge_data.drop([discharge_data.index[128]]) # this sample does not have a GT diagnosis, discard it.
    ...
    if use_case == "phy_baseline":
        ...
        for index, row in tqdm(discharge_data.iterrows(), total=len(discharge_data)):
            ...
            phy_dial_hist[index] = str(ass_history)
            ass_dial_hist[index] = str(phy_history)
